...
## Introduction
Chapter 5 introduces the basics of English syntax and explains how sentences are organized into grammatical units called **constituents**. Syntax is hierarchical and consists of four levels:
- sentences
- clauses
- phrases
- words
...
- constituents move together in passive constructions or questions
> These tests show that syntax is systematic rather than random.
---
## Formal vs. Notional Definitions
The chapter contrasts:
| Formal definitions | Notional definitions |
|---|---|
...
The **predicator** is a central clause function consisting of a lexical verb and any accompanying auxiliary verbs. It is important because it determines the **argument structure** of a clause — in other words, which other clause elements may occur.
Some verbs are **intransitive**, meaning they do not take objects. For example, *died* can occur with only a subject.
Other verbs are **transitive** and allow objects. The verb *gave* requires more clause elements, such as a subject and one or more objects.
Because of this, the predicator controls much of a sentence’s grammatical organization.
...
Clause functions are identified through their relationships with one another rather than through meaning alone.
The main clause functions in English include:
- subject  
- predicator  
- object  
- complement  
...
English contains four major sentence types:
- declarative  
- interrogative  
- imperative  
- exclamatory  
...
The **subject** and **predicator** are central components of most English clauses.
Predicators consist entirely of verbal elements, including lexical verbs and optional auxiliary verbs.
Subjects are more varied and may take the form of noun phrases or clauses. Because many constituents can appear before the verb, identifying the subject requires more than simply looking at word order.
One important clue is **subject–verb agreement**. In a clause, the subject agrees with the verb in number.
For example, in:
*This morning, two workmen were screwing new bulbs into the sockets*
the plural verb *were* identifies *two workmen* as the subject rather than *This morning*.

## Subject–Operator Inversion

English questions frequently involve **subject–operator inversion**.
In yes/no questions, the **operator** changes position with the subject.
Examples include:
